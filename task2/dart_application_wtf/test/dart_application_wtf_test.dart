...
void main() {
  ...
  test('intersectCount = 2,v.2', () {
    final first = Circle(center: kPoint(x: 4, y: 3), radius: 1);
    final second = Circle(center: kPoint(x: 1, y: 3), radius: 3);
    final result = Result();
    expect(result.findIntersect(first: first,second: second).intersectCount, 2);
    expect(result.findIntersect(first: first,second: second).timeExecuting, lessThan(1));
  ...
  test('intersectCount = 2,v.3', () {
    final first = Circle(center: kPoint(x: 5, y: 3), radius: 2);
    final second = Circle(center: kPoint(x: 1, y: 3), radius: 3);
    final result = Result();
    expect(result.findIntersect(first: first,second: second).intersectCount, 2);
    expect(result.findIntersect(first: first,second: second).timeExecuting, lessThan(1));
  ...
  test('intersectCount = 1,v.1', () {
    final first = Circle(center: kPoint(x: 1, y: 2), radius: 2);
    final second = Circle(center: kPoint(x: 1, y: 3), radius: 3);
    final result = Result();
  ...
  test('intersectCount = 1,v.2', () {
    final first = Circle(center: kPoint(x: 2, y: 3), radius: 4);
    final second = Circle(center: kPoint(x: 1, y: 3), radius: 3);
    final result = Result();
    expect(result.findIntersect(first: first,second: second).intersectCount, 1);
    expect(result.findIntersect(first: first,second: second).timeExecuting, lessThan(1));
  ...
  test('intersectCount = 0,v.1', () {
    final first = Circle(center: kPoint(x: 50, y: 3), radius: 3);
    final second = Circle(center: kPoint(x: 1, y: 3), radius: 3);
    final result = Result();
  ...
  test('intersectCount = -1,v.1', () {
    final first = Circle(center: kPoint(x: 2, y: 3), radius: 3);
    final second = Circle(center: kPoint(x: 2, y: 3), radius: 3);
    final result = Result();
    expect(result.findIntersect(first: first,second: second).intersectCount, -1);
    expect(result.findIntersect(first: first,second: second).timeExecuting, lessThan(1));
  });
